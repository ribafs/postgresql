-- Banco de teste para PostgreSQL
-- 
/*
Controle de Estoque é o conjunto de atividades que tem como objetivo colocar na empresaz a mercadoria
...
(
	...
	constraint empresa_fk foreign key (empresa) references empresas(id)
);
--
...
(
	...
	constraint produto_fk foreign key (produto) references produtos(id),
	constraint compra_fk foreign key (compra) references compras(id)
);
-- 
...
(
	id int primary key, -- Cada compra e cada venda de produto atualizar o estoque. Na compra a atualização é manual e na venda automático
	...
	constraint armazem_fk foreign key (armazem) references armazens(id),
	constraint compra_fk foreign key (compra_item) references compra_itens(id)
);
--
...
(
	...
	constraint funcionario_fk foreign key (funcionario) references funcionarios(id)
);
--
create table bonus
(
...
(
	...
	pedido int not null,
	constraint estoque_fk foreign key (estoque) references estoque(id),
	constraint pedido_fk foreign key (pedido) references pedidos(id)
);
...
--
--
INSERT INTO fornecedores (id,cnpj,nome,site,email,contato, telefone) VALUES 
...
--
INSERT INTO armazens (id,descricao,armario,prateleira) VALUES
...
--
--
INSERT INTO compras (id, data_atualizacao, fornecedor) VALUES
(1, '14/06/2008', 1);
--
INSERT INTO compra_itens (id, compra, produto,quantidade,preco_unitario,estoque_min) VALUES
(1,1,1, 5, 12.35, 2),
(2,1,2, 12, 265.00, 2),
(3,1,3, 8, 1965.00, 1),
(4,1,4, 15, 45.36, 3),
...
--
--
INSERT INTO estoque (id,quant_estoque,estoque_max,estoque_min,preco_venda, data_atualizacao,armazem, compra_item) VALUES
...
--
--
INSERT INTO pedidos (id,cliente,funcionario,data_pedido,data_confirmacao) VALUES
...
--
--
INSERT INTO pedido_itens (id,estoque,quantidade,preco_venda,pedido) VALUES
(1, 1, 2, 15.00,1),
(2, 9, 1, 10.20,1),
(3, 14, 1, 38.50,1),
(4, 9, 1, 10.20,2),
...
--
--
INSERT INTO bonus (id,valor_bonus,pedido,data_pedido) VALUES
(1, 1.91, 1, '12/06/2008'), -- Exemplo para este bônus: 3% de (15 + 10.20 + 38.50)
(2, 0.35, 2, '12/06/2008');
--
--
INSERT INTO comissoes (id,valor_comissao,data_pedido,pedido) VALUES
